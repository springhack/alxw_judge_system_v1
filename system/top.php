    ...
    <body>
    	...
    	<?php
			...
			for ($i=0;$i<count($list);++$i)
				echo "<tr><td>".($sstart + $i + 1)."</td><td><a href='person.php?id=".$list[$i]['user']."'>".$list[$i]['nick']."</a></td><td>".unserialize($list[$i]['json'])['quote']."</td><td>".$list[$i]['ac']."</td><td>".$list[$i]['su']."</td><td>".intval($list[$i]['ac']*100/$list[$i]['su'])."%</td></tr>";
			echo "</table>";
		?><br /><br />
